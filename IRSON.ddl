...
CREATE TABLE SPORT_CLUB (
    ...
    CONSTRAINT unique_club_name_per_country UNIQUE (name, country_id)
);
...
FROM 'C:/Users/Lenovo/Desktop/Fakultet-Ja/Fakultet/NapredniBazi/boyNames.txt';

COPY temp_female_names (name)
FROM 'C:/Users/Lenovo/Desktop/Fakultet-Ja/Fakultet/NapredniBazi/girlNames.txt';
...
from NATIONAL_FEDERATION nf
    ...
    join SPORT s on f.sport_id=s.id
    join COUNTRY c on nf.country_id=c.id;
